...
class WekaUtil {
    ...
    public static Instance getInstance(WordUtterance wordUtt) {
        ...
        // Vowels
        inst.setValue(DATASET.attribute("V0_F0_MEAN"), featex.getVowelF0Mean(0))
        inst.setValue(DATASET.attribute("V0_F0_MAX"), featex.getVowelF0Max(0))
        inst.setValue(DATASET.attribute("V0_F0_MIN"), featex.getVowelF0Min(0))
        inst.setValue(DATASET.attribute("V0_F0_RANGE"), featex.getVowelF0Range(0))
        inst.setValue(DATASET.attribute("V1_F0_MEAN"), featex.getVowelF0Mean(1))
        inst.setValue(DATASET.attribute("V1_F0_MAX"), featex.getVowelF0Max(1))
        inst.setValue(DATASET.attribute("V1_F0_MIN"), featex.getVowelF0Min(1))
        inst.setValue(DATASET.attribute("V1_F0_RANGE"), featex.getVowelF0Range(1))
        // Relative
        inst.setValue(DATASET.attribute("REL_SYLL_F0_MEAN"), featex.getRelSyllF0Mean())
        inst.setValue(DATASET.attribute("REL_SYLL_F0_MAX"), featex.getRelSyllF0Max())
        inst.setValue(DATASET.attribute("REL_SYLL_F0_MIN"), featex.getRelSyllF0Min())
        inst.setValue(DATASET.attribute("REL_SYLL_F0_RANGE"), featex.getRelSyllF0Range())
        inst.setValue(DATASET.attribute("REL_VOWEL_F0_MEAN"), featex.getRelVowelF0Mean())
        inst.setValue(DATASET.attribute("REL_VOWEL_F0_MAX"), featex.getRelVowelF0Max())
        inst.setValue(DATASET.attribute("REL_VOWEL_F0_MIN"), featex.getRelVowelF0Min())
        inst.setValue(DATASET.attribute("REL_VOWEL_F0_RANGE"), featex.getRelVowelF0Range())
        inst.setValue(DATASET.attribute("F0_MAX_INDEX"), featex.getMaxF0Index())
        inst.setValue(DATASET.attribute("F0_MIN_INDEX"), featex.getMinF0Index())
        inst.setValue(DATASET.attribute("F0_MAXRANGE_INDEX"), featex.getMaxRangeF0Index())

        //// ENERGY
        //Word
        inst.setValue(DATASET.attribute("WORD_ENERGY_MEAN"), featex.getWordEnergyMean())
        inst.setValue(DATASET.attribute("WORD_ENERGY_MAX"), featex.getWordEnergyMax())
        //Syllables
        inst.setValue(DATASET.attribute("SYLL0_ENERGY_MEAN"), featex.getSyllableEnergyMean(0))
        inst.setValue(DATASET.attribute("SYLL0_ENERGY_MAX"), featex.getSyllableEnergyMax(0))
        inst.setValue(DATASET.attribute("SYLL1_ENERGY_MEAN"), featex.getSyllableEnergyMean(1))
        inst.setValue(DATASET.attribute("SYLL1_ENERGY_MAX"), featex.getSyllableEnergyMax(1))
        //Vowels
        inst.setValue(DATASET.attribute("V0_ENERGY_MEAN"), featex.getVowelEnergyMean(0))
        inst.setValue(DATASET.attribute("V0_ENERGY_MAX"), featex.getVowelEnergyMax(0))
        inst.setValue(DATASET.attribute("V1_ENERGY_MEAN"), featex.getVowelEnergyMean(1))
        inst.setValue(DATASET.attribute("V1_ENERGY_MAX"), featex.getVowelEnergyMax(1))
        //Relative
        inst.setValue(DATASET.attribute("REL_SYLL_ENERGY_MEAN"), featex.getRelSyllEnergyMean())
        inst.setValue(DATASET.attribute("REL_SYLL_ENERGY_MAX"), featex.getRelSyllEnergyMax())
        inst.setValue(DATASET.attribute("REL_VOWEL_ENERGY_MEAN"), featex.getRelVowelEnergyMean())
        inst.setValue(DATASET.attribute("REL_VOWEL_ENERGY_MAX"), featex.getRelVowelEnergyMax())
        inst.setValue(DATASET.attribute("ENERGY_MAX_INDEX"), featex.getMaxEnergyIndex())
